...
class LogOutTest {
  ...
  void logOutTest() throws InterruptedException {
    ...
    driver.manage().window().setSize(new Dimension(1267, 842));
      ...
      loginPage.submit();
      Thread.sleep(3000);
    driver.findElement(By.xpath("//div[@id=\'common_menu\']/div/div/div/a/div")).click();
      Thread.sleep(3000);

      driver.findElement(By.xpath("//a[contains(text(),\'Выйти\')]")).click();
      Thread.sleep(3000);

      MatcherAssert.assertThat(driver.findElement(By.xpath("//a[contains(text(),\'Войти\')]")).getText(), is("Войти"));
  }
}
